...
import '../../../data/models/providers/auth/register.dart';
import '../../../data/requests/providers/auth/providers_register_request.dart';
import '../../../data/requests/user/auth/user_register_resend_confirmation_code_request.dart';

part 'providers_auth_state.dart';

class ProvidersAuthCubit extends Cubit<ProvidersAuthStates> {
  ProvidersAuthCubit() : super(ProvidersAuthInitial());

  static ProvidersAuthCubit get(context) => BlocProvider.of(context);
  ...
  // }
  //
  // ProvidersRegisterModel? providersRegisterModel;
  //
  // void providersRegister({
  //   required String phone,
  //   required String name,
  //   required String password,
  //   required bool acceptTerms,
  // }) {
  //   emit(ProvidersRegisterLoadingState());
  //   ProvidersRegisterRequest.providersRegisterRequest(
  //           password: password,
  //           phone: phone,
  //           acceptTerms: acceptTerms,
  //           name: name)
  //       .then((value) {
  //     providersRegisterModel = value;
  //     if (providersRegisterModel!.status.toString() == '200') {
  //       emit(ProvidersRegisterSuccessState());
  //     } else {
  //       emit(ProvidersRegisterErrorState(providersRegisterModel!.message));
  //     }
  //   }).catchError((error) {
