...
const DELIVERY_REPRESENTATIVE_DELIVERY_ORDERS_SCREEN =
    '/drivers/order/delivered';
const DELIVERY_REPRESENTATIVE_NON_WAITING_ORDERS_SCREEN =
    '/drivers/nonwaiting/orders';
const DELIVERY_REPRESENTATIVE_ORDERS_DECISION_SCREEN =
    '/drivers/order/decision';
const DELIVERY_REPRESENTATIVE_ORDERS_DETAILS_SCREEN = '/drivers/order/details';
const DELIVERY_REPRESENTATIVE_RECIEVED_ORDERS_SCREEN =
    '/drivers/order/recieved';
const DELIVERY_REPRESENTATIVE_WAITING_ORDERS_SCREEN = '/drivers/waiting/orders';
