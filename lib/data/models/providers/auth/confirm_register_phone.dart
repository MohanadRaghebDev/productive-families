class ProvidersConfirmRegisterPhoneModel {
  int? status;
  String? message;
  Account? account;

  ProvidersConfirmRegisterPhoneModel({this.status, this.message, this.account});

  ProvidersConfirmRegisterPhoneModel.fromJson(Map<String, dynamic> json) {
    status = json['status'];
